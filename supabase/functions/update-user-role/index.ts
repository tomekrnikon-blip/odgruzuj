...
serve(async (req) => {
  ...
  try {
    ...
    console.log('[UPDATE-USER-ROLE] User check:', { userId: user?.id, error: userError?.message });
    ...
    console.log('[UPDATE-USER-ROLE] Admin check:', { adminRole, error: roleError?.message });
